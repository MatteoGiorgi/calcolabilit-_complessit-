# Automi e linguaggi \hfill \textcolor{gray75}{\faCube}
...
\begin{center}
\texttt{se} $A$ è regolare $\Leftrightarrow$ $\exists$ $M$ che riconosce $A$ $\Leftrightarrow$ $M$ accetta tutte le stringhe di $A$ \texttt{es}
\end{center}
...
\begin{center}
\texttt{se} $\exists$ un NFA che riconosce $L$ $\Leftrightarrow$ $\exists$ un DFA che riconosce $L$ $\Leftrightarrow$ $L$ è regolare \texttt{es}
\end{center}
\begin{proof}
