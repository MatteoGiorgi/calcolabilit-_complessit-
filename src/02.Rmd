...
\begin{definition}
Un linguaggio si dice \underline{Turing-riconoscibile} se esiste una MdT che lo riconosce (per ogni stringa del linguaggio termina nello stato di accettazione $q_A$).
\end{definition}

\begin{definition}
Un linguaggio si dice \underline{Turing-decidibile} se esiste una MdT che lo decide (per ogni stringa del linguaggio termina nello stato di accettazione $q_A$, per tutte le altre termina nello stato si rifiuto $q_R$).
\end{definition}
