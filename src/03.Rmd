...
Che succederebbe adesso usassi la codifica di una MdT invece che quella di un automa? Posso determinare se una MdT accetta una determinata stringa? (no)
...
sollicitudin. Mauris aliquam mauris ut tortor. Pellentesque.
