...
* gli *stati* $q_i$ della macchina appartengono all'insieme finito degli stati $Q$ e identificano istante per istante le informazioni contenute nella macchina
...
\begin{itemize}[itemsep=-7pt]
\item $Q$ è l'insieme finito degli stati $q_i$ che non contiene gli stati terminali $q_A$ e $q_R$
\item $\Sigma{\nsupseteq}\{\Lleftarrow,\Rrightarrow,\equiv\}$ è sempre l'insieme finito dei simboli (alfabeto di macchina)
