...
\begin{definition}
Una \underline{computazione} di una MdT è una successione di configurazioni, ogniuna ottenuta dalla precedente in accordo con la definizione di funzione di transizione $\delta$
\end{definition}
