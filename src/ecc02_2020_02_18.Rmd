...
luctus bibendum velit. Morbi faucibus volutpat sapien.

```{python echo=FALSE, eval=TRUE, results='hide', out.width="50%", fig.align="center", fig.cap="Haba-haba ;)"}
...
Nam ac mauris at justo adipiscing facilisis.
